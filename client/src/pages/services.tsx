import { Brain, BarChart, Users, Building, Server, Cog, ArrowLeft } from "lucide-react";
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-gradient-to-br from-gray-800 to-gray-900 p-8 rounded-2xl border border-gray-700">
              ...
              <h3 className="text-2xl font-bold mb-4 text-blue-400">Cloud Transformation</h3>
            ...
            <div className="bg-gradient-to-br from-gray-800 to-gray-900 p-8 rounded-2xl border border-gray-700">
              ...
              <h3 className="text-2xl font-bold mb-4 text-emerald-400">AI & Machine Learning</h3>
              <p className="text-gray-300 mb-6">
            ...
            <div className="bg-gradient-to-br from-gray-800 to-gray-900 p-8 rounded-2xl border border-gray-700">
              ...
              <h3 className="text-2xl font-bold mb-4 text-amber-400">Data Analytics</h3>
              <p className="text-gray-300 mb-6">
            ...
            <div className="bg-gradient-to-br from-gray-800 to-gray-900 p-8 rounded-2xl border border-gray-700">
              ...
              <h3 className="text-2xl font-bold mb-4 text-pink-400">Staff Augmentation</h3>
              <p className="text-gray-300 mb-6">
            ...
            <div className="bg-gradient-to-br from-gray-800 to-gray-900 p-8 rounded-2xl border border-gray-700">
              ...
              <h3 className="text-2xl font-bold mb-4 text-red-400">Government Solutions</h3>
              <p className="text-gray-300 mb-6">
            ...
            <div className="bg-gradient-to-br from-gray-800 to-gray-900 p-8 rounded-2xl border border-gray-700">
              ...
              <h3 className="text-2xl font-bold mb-4 text-indigo-400">Digital Engineering</h3>
              <p className="text-gray-300 mb-6">
