      ...
      <div className="pt-20 pb-10 zoom-container">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 zoom-section">
          <h1 className="text-5xl md:text-6xl font-bold mb-6 reveal-scale">
            <span className="gradient-text">Enterprise Solutions That Deliver Measurable Outcomes</span>
          </h1>
          <p className="text-xl text-gray-300 max-w-4xl reveal-fade" data-delay="200">
            At Procyon, we go beyond implementation. Our <span className="text-emerald-400 font-semibold">Enterprise Solutions</span> practice combines strategy, execution, and adoption so you see <span className="text-emerald-400 font-semibold">results in 90 days or less</span>.
          </p>
        </div>
      </div>
          ...
          <div className="grid md:grid-cols-3 gap-12">
            ...
            <div className="group floating-card conic-border bg-gradient-to-br from-gray-800 to-gray-900 p-8 rounded-2xl border border-gray-700 hover:border-blue-500 cursor-pointer transition-all duration-300 reveal-fade" data-delay="100" onClick={() => {window.scrollTo(0, 0); window.location.href = '/enterprise/salesforce';}}>
              <div className="w-20 h-20 bg-blue-500/20 rounded-xl flex items-center justify-center mb-8 relative z-10">
                <SiSalesforce className="w-10 h-10 text-blue-400" />
              </div>
              ...
              <p className="text-gray-300 mb-8 leading-relaxed relative z-10 italic">
                AI-driven CRM for tomorrow's enterprises.
              </p>
              
              <div className="space-y-4 relative z-10">
                <ul className="space-y-3 text-gray-300">
                  <li>• Intelligent automation & workflows</li>
                  <li>• Advanced analytics & customer insights</li>
            ...
            <div className="group floating-card conic-border bg-gradient-to-br from-gray-800 to-gray-900 p-8 rounded-2xl border border-gray-700 hover:border-emerald-500 cursor-pointer transition-all duration-300 reveal-fade" data-delay="200" onClick={() => {window.scrollTo(0, 0); window.location.href = '/enterprise/servicenow';}}>
              <div className="w-20 h-20 bg-emerald-500/20 rounded-xl flex items-center justify-center mb-8 relative z-10">
                <ServiceNowLogo className="w-10 h-10 text-emerald-400" />
              </div>
              ...
              <div className="space-y-4 relative z-10">
                <ul className="space-y-3 text-gray-300">
                  <li>• ITSM, ITOM, and CSM expertise</li>
                  <li>• HR & Security Operations</li>
            ...
            {/* SAP */}
            <div className="conic-border bg-gradient-to-br from-gray-800 to-gray-900 p-8 rounded-2xl border border-gray-700 hover:border-purple-500 cursor-pointer transition-all duration-300 reveal-fade" data-delay="300" onClick={() => {window.scrollTo(0, 0); window.location.href = '/enterprise/sap';}}>
              ...
              <p className="text-gray-300 mb-8 leading-relaxed relative z-10 italic">
                ERP built for operational excellence.
              </p>
              
              <div className="space-y-4 relative z-10">
                <ul className="space-y-3 text-gray-300">
                  <li>• SAP S/4HANA implementation</li>
                  <li>• Finance & supply chain optimization</li>
