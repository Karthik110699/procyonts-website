      ...
      <section className="py-20 zoom-container">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 zoom-section">
          <div className="grid md:grid-cols-3 gap-12">
            ...
            {/* SalesForce */}
            <div className="group floating-card conic-border bg-gradient-to-br from-gray-800 to-gray-900 p-8 rounded-2xl border border-gray-700 hover:border-blue-500 cursor-pointer transition-all duration-300 reveal-scale" data-delay="100" onClick={() => {window.scrollTo(0, 0); window.location.href = '/enterprise/salesforce';}}>
            ...
            {/* ServiceNow */}
            <div className="group floating-card conic-border bg-gradient-to-br from-gray-800 to-gray-900 p-8 rounded-2xl border border-gray-700 hover:border-emerald-500 cursor-pointer transition-all duration-300 reveal-scale" data-delay="150" onClick={() => {window.scrollTo(0, 0); window.location.href = '/enterprise/servicenow';}}>
            ...
            {/* SAP */}
            <div className="group floating-card conic-border bg-gradient-to-br from-gray-800 to-gray-900 p-8 rounded-2xl border border-gray-700 hover:border-purple-500 cursor-pointer transition-all duration-300 reveal-scale" data-delay="200" onClick={() => {window.scrollTo(0, 0); window.location.href = '/enterprise/sap';}}>
          ...
          {/* CTA Section */}
          <div className="text-center mt-20 reveal-scale" data-delay="300">
            ...
            <Link href="/contact" className="inline-block bg-gradient-to-r from-blue-600 to-emerald-600 px-8 py-4 rounded-lg font-semibold text-lg hover:scale-105 transition-transform" onClick={() => window.scrollTo(0, 0)}>
              Get Started Today
            </Link>
          </div>
        </div>
