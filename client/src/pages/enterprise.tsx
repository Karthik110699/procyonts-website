        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-3 gap-12">
            ...
            <div className="bg-gradient-to-br from-gray-800 to-gray-900 p-8 rounded-2xl border border-gray-700">
              <div className="w-20 h-20 bg-blue-500/20 rounded-xl flex items-center justify-center mb-8">
                <Cloud className="w-10 h-10 text-blue-400" />
              </div>
              <h2 className="text-3xl font-bold mb-6 text-blue-400">SalesForce</h2>
            ...
            {/* ServiceNow */}
            <div className="bg-gradient-to-br from-gray-800 to-gray-900 p-8 rounded-2xl border border-gray-700">
              <div className="w-20 h-20 bg-emerald-500/20 rounded-xl flex items-center justify-center mb-8">
                <Settings className="w-10 h-10 text-emerald-400" />
              </div>
              <h2 className="text-3xl font-bold mb-6 text-emerald-400">ServiceNow</h2>
              <p className="text-gray-300 mb-8 leading-relaxed">
            ...
            {/* SAP */}
            <div className="bg-gradient-to-br from-gray-800 to-gray-900 p-8 rounded-2xl border border-gray-700">
              <div className="w-20 h-20 bg-purple-500/20 rounded-xl flex items-center justify-center mb-8">
                <Database className="w-10 h-10 text-purple-400" />
              </div>
              <h2 className="text-3xl font-bold mb-6 text-purple-400">SAP</h2>
              <p className="text-gray-300 mb-8 leading-relaxed">
