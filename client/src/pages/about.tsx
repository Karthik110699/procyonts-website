...
export default function AboutPage() {
  ...
  useEffect(() => {
    ...
    const conicBorders = document.querySelectorAll('.conic-border');
    ...
    const observer = new IntersectionObserver((entries) => {
      entries.forEach((entry) => {
        if (entry.isIntersecting) {
          ...
          const conicBorder = element.querySelector('.conic-border');
          if (conicBorder) {
            conicBorder.classList.add('active');
          }
        }
      });
    }, observerOptions);
            ...
            <div className="space-y-12 md:space-y-16 lg:space-y-24">
              ...
              <div className="timeline-item timeline-item-left relative flex flex-col md:flex-row items-center" data-year="2004">
                <div className="w-full md:flex-1 text-center md:text-right md:pr-8 mb-4 md:mb-0">
                  <div className="conic-border bg-gradient-to-br from-blue-800 to-blue-900 p-4 md:p-6 rounded-xl border border-blue-500/30 transition-all duration-500 hover:shadow-2xl hover:shadow-blue-500/20">
              ...
              <div className="timeline-item timeline-item-right relative flex flex-col md:flex-row items-center" data-year="2008">
                ...
                <div className="w-full md:flex-1 text-center md:text-left md:pl-8 mb-4 md:mb-0">
                  <div className="conic-border bg-gradient-to-br from-emerald-800 to-emerald-900 p-4 md:p-6 rounded-xl border border-emerald-500/30 transition-all duration-500 hover:shadow-2xl hover:shadow-emerald-500/20">
              ...
              <div className="timeline-item timeline-item-left relative flex flex-col md:flex-row items-center" data-year="2015">
                <div className="w-full md:flex-1 text-center md:text-right md:pr-8 mb-4 md:mb-0">
                  <div className="conic-border bg-gradient-to-br from-purple-800 to-purple-900 p-4 md:p-6 rounded-xl border border-purple-500/30 transition-all duration-500 hover:shadow-2xl hover:shadow-purple-500/20">
              ...
              <div className="timeline-item timeline-item-right relative flex flex-col md:flex-row items-center" data-year="2018">
                ...
                <div className="w-full md:flex-1 text-center md:text-left md:pl-8 mb-4 md:mb-0">
                  <div className="conic-border bg-gradient-to-br from-amber-800 to-amber-900 p-4 md:p-6 rounded-xl border border-amber-500/30 transition-all duration-500 hover:shadow-2xl hover:shadow-amber-500/20">
              ...
              <div className="timeline-item timeline-item-left relative flex flex-col md:flex-row items-center" data-year="2020">
                <div className="w-full md:flex-1 text-center md:text-right md:pr-8 mb-4 md:mb-0">
                  <div className="conic-border bg-gradient-to-br from-cyan-800 to-cyan-900 p-4 md:p-6 rounded-xl border border-cyan-500/30 transition-all duration-500 hover:shadow-2xl hover:shadow-cyan-500/20">
              ...
              <div className="timeline-item timeline-item-right relative flex flex-col md:flex-row items-center" data-year="2022">
                ...
                <div className="w-full md:flex-1 text-center md:text-left md:pl-8 mb-4 md:mb-0">
                  <div className="conic-border bg-gradient-to-br from-rose-800 to-rose-900 p-4 md:p-6 rounded-xl border border-rose-500/30 transition-all duration-500 hover:shadow-2xl hover:shadow-rose-500/20">
              ...
              <div className="timeline-item timeline-item-left relative flex flex-col md:flex-row items-center" data-year="2023">
                <div className="w-full md:flex-1 text-center md:text-right md:pr-8 mb-4 md:mb-0">
                  <div className="conic-border bg-gradient-to-br from-green-800 to-green-900 p-4 md:p-6 rounded-xl border border-green-500/30 transition-all duration-500 hover:shadow-2xl hover:shadow-green-500/20">
              ...
              <div className="timeline-item timeline-item-right relative flex flex-col md:flex-row items-center" data-year="2025">
                ...
                <div className="w-full md:flex-1 text-center md:text-left md:pl-8 mb-4 md:mb-0">
                  <div className="conic-border bg-gradient-to-br from-violet-800 to-violet-900 p-4 md:p-6 rounded-xl border border-violet-500/30 transition-all duration-500 hover:shadow-2xl hover:shadow-violet-500/20">
