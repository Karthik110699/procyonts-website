      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-20">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {/* SalesForce */}
            <div className="group floating-card dynamic-stroke bg-gradient-to-br from-gray-800 to-gray-900 p-8 rounded-2xl border border-gray-700 hover:border-blue-500 reveal cursor-pointer transition-all duration-300" style={{ animationDelay: '0.1s' }} onClick={() => window.location.href = '/enterprise/salesforce'}>
            ...
            {/* ServiceNow */}
            <div className="group floating-card dynamic-stroke bg-gradient-to-br from-gray-800 to-gray-900 p-8 rounded-2xl border border-gray-700 hover:border-emerald-500 reveal cursor-pointer transition-all duration-300" style={{ animationDelay: '0.2s' }} onClick={() => window.location.href = '/enterprise/servicenow'}>
            ...
            {/* SAP */}
            <div className="group floating-card dynamic-stroke bg-gradient-to-br from-gray-800 to-gray-900 p-8 rounded-2xl border border-gray-700 hover:border-purple-500 reveal cursor-pointer transition-all duration-300" style={{ animationDelay: '0.3s' }} onClick={() => window.location.href = '/enterprise/sap'}>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          <div className="group floating-card dynamic-stroke bg-gradient-to-br from-gray-800 to-gray-900 p-8 rounded-2xl border border-gray-700 hover:border-blue-500 reveal cursor-pointer transition-all duration-300" style={{ animationDelay: '0.4s' }} onClick={() => window.location.href = '/services/cloud'}>
            <div className="w-16 h-16 bg-blue-500/20 rounded-xl flex items-center justify-center mb-6 group-hover:bg-blue-500/30 transition-colors relative z-10">
          ...
          {/* AI & ML */}
          <div className="group floating-card dynamic-stroke bg-gradient-to-br from-gray-800 to-gray-900 p-8 rounded-2xl border border-gray-700 hover:border-emerald-500 reveal cursor-pointer transition-all duration-300" style={{ animationDelay: '0.5s' }} onClick={() => window.location.href = '/services/ai-ml'}>
            <div className="w-16 h-16 bg-emerald-500/20 rounded-xl flex items-center justify-center mb-6 group-hover:bg-emerald-500/30 transition-colors relative z-10">
          ...
          {/* Data Strategy */}
          <div className="group floating-card dynamic-stroke bg-gradient-to-br from-gray-800 to-gray-900 p-8 rounded-2xl border border-gray-700 hover:border-purple-500 reveal cursor-pointer transition-all duration-300" style={{ animationDelay: '0.6s' }} onClick={() => window.location.href = '/services/data-analytics'}>
            <div className="w-16 h-16 bg-purple-500/20 rounded-xl flex items-center justify-center mb-6 group-hover:bg-purple-500/30 transition-colors relative z-10">
          ...
          {/* Staff Augmentation */}
          <div className="group floating-card dynamic-stroke bg-gradient-to-br from-gray-800 to-gray-900 p-8 rounded-2xl border border-gray-700 hover:border-amber-500 reveal cursor-pointer transition-all duration-300" style={{ animationDelay: '0.7s' }} onClick={() => window.location.href = '/services/staff-augmentation'}>
          ...
          <div className="group floating-card dynamic-stroke bg-gradient-to-br from-gray-800 to-gray-900 p-8 rounded-2xl border border-gray-700 hover:border-red-500 reveal cursor-pointer transition-all duration-300" style={{ animationDelay: '0.8s' }} onClick={() => window.location.href = '/services/government'}>
